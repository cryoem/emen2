...
<div style="float:left;width:600px;margin-left:20px;">
	...
	<%call expr="buttons.singlepage('userinfo2','Contact Information (required)')">
		<table  class="signup">	
			<tbody>					
	...
	<%call expr="buttons.singlepage('userinfo3','Additional Information (optional)')">
		<table class="signup">	
			<tbody>					
				<tr>
	...
	<%call expr="buttons.singlepage('usertype','Comments')">
	
		<p>
			Please let us know why you are requesting an account:
		</p>
