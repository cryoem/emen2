...
class URL(object):
	...
	def method_notsupported(inp, *args, **kwargs):
		raise emen2.web.responsecodes.MethodNotAllowedError(inp)
...
class URLRegistry(object):
	...
	@staticmethod
	def onfail(inp):
		raise emen2.web.responsecodes.NotFoundError(inp)

	@staticmethod
	def onfail1(m1,m2):
		raise emen2.web.responsecodes.HTTPResponseCode, 'Method mismatch: %s, %s' % (m1,m2)
