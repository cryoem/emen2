...
<p>If you have created your account, please <a href="${EMEN2WEBROOT}/login/?uri=${EMEN2WEBROOT+"/proposals/new/"|u}">login to begin</a>.</p>
...
<form action="${EMEN2WEBROOT}/proposals/new/" method="post"  enctype="multipart/form-data">
