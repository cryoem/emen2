    ...
    $.widget("ui.MapSelect", {
		...
		build: function() {
			...
			if (!this.options.ext_save) {
				this.options.ext_save = $('<div class="controls bigbutton"><img class="spinner" style="display:none" src="'+EMEN2WEBROOT+'/static/images/spinner.gif" alt="Loading" /><input type="button" value="Save" name="save" /></div>');
