...
<div class="e2l-sidebar-sidebar">
	...
	% if ADMIN:
    	<a class="e2-button e2-record-new" href="${ctxt.root}/record/0/new/${default_group.name}/" data-parent="0" data-rectype="${default_group.name}">${buttons.image('new.png')} New ${default_group.desc_short}</a>
	% endif
