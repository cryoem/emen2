...
paramdefs =  [
 ...
 {'children': ['category_image',
                ...
                'description_genetic',
                'comment_purpose',
                'description_storage'],'desc_long': 'Textual descriptions',
 ...
 {'children': ['vitrobot_humidity', 'humidity_ambient'],'desc_long': 'Humidity',
  'desc_short': 'Humidity',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'humidity',
 ...
 {'children': ['tem_dose_rate'],'desc_long': 'Rate parameters',
 ...
 {'children': ['lens_voltage_projector', 'lens_voltage_objective'],'desc_long': 'Lens voltage',
 ...
 {'children': ['current_screen', 'current_lens'],'desc_long': 'Current',
  'desc_short': 'Current',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'current',
 ...
 {'children': ['box_label',
                ...
                'box_color',
                'box_coords',
                'box_size'],'desc_long': 'Box file attachments. Typically ordered by date.',
 ...
 {'children': ['ctf_ampcont',
                ...
                'ctf_snr_max',
                'ctf_bfactor',
                'ctf_drift_angle'],'desc_long': 'CTF details',
 ...
 {'children': ['ddd_sensor_offset',
                ...
                'ddd_binary_sum',
                'ddd_binary_info',
                'ddd_binary_final'],'desc_long': 'Direct Electron Detector parameters',
 ...
 {'choices': ['Rejected',
               ...
               'Analysis',
               'Imaging',
               'Manuscript Prep.'],'desc_long': 'The current state of this project',
 ...
 {'children': ['tem_magnification_measured', 'tem_magnification_set'],'desc_long': 'Magnification',
 ...
 {'children': ['roi_offset_y',
                ...
                'roi_offset_w',
                'roi_offset_h',
                'ddd_camera'],'desc_long': 'Camera details',
 ...
 {'children': ['sequence_rna', 'sequence_dna', 'sequence_protein'],'desc_long': 'Sequence',
  'desc_short': 'Sequence',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'sequence',
 ...
 {'children': ['description_storage_location',
                ...
                'mass_specimen',
                'symmetry_particle',
                'description_storage'],'desc_long': 'Biological target',
 ...
 {'children': ['lens_voltage_objective'],'defaultunits': 'kV',
 ...
 {'children': ['voltage_lens'],'defaultunits': 'A',
 ...
 {'children': ['hazard_bl_max'],'desc_long': 'Hazards',
  'desc_short': 'Hazards',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'hazard',
 ...
 {'children': ['description_purification'],'desc_long': 'Purification parameters',
 ...
 {'children': ['ctf', 'magnification', 'binning'],'desc_long': 'Imaging',
  'desc_short': 'Imaging',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'imaging',
 ...
 {'children': ['ctf_defocus_set',
                ...
                'diameter_min',
                'ccd_pixelsize',
                'aberration_chromatic'],'desc_long': 'Length',
  'desc_short': 'Length',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'length',
 ...
 {'children': ['symmetry_particle'],'desc_long': 'Symmetry',
  'desc_short': 'Symmetry',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'symmetry',
 ...
 {'children': ['description_genetic',
                ...
                'description_medical_relevance',
                'description_purpose',
                'description_background'],'desc_long': 'Biological details',
 ...
 {'children': ['journal_volume',
                ...
                'title_publication',
                'name_journal',
                'type_publication'],'desc_long': 'Publication details',
 ...
 {'children': ['concentration_pf',
                'concentration_pml',
                'absorbance_at_wavelength',
                'concentration_solution'],'desc_long': 'Concentration',
 ...
 {'children': ['specimen_tilt',
                'angle_illumination',
                'ctf_drift_angle',
                'ctf_astig_angle'],'desc_long': 'Angle',
  'desc_short': 'Angle',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'angle',
 ...
 {'children': ['website', 'url_list', 'url_journal'],'desc_long': 'URI References',
 ...
 {'children': ['vitrobot_time_wait',
                ...
                'vitrobot_time_step',
                'vitrobot_time_drain',
                'direction_blotting'],'desc_long': 'Blotting parameters',
 ...
 {'children': ['film_screen_ratio', 'ccd_screen_ratio', 'dose'],'desc_long': 'Ratio',
  'desc_short': 'Ratio',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'ratio',
 ...
 {'children': ['dilution', 'freezing', 'microscopy', 'purification'],'desc_long': 'Parameters for experimental techniques',
 ...
 {'children': ['blotting', 'vitrification', 'select_technique_freezing'],'desc_long': 'Freezing parameters',
 ...
 {'children': ['ccd_screen_ratio',
                ...
                'ccd_size_pix_x',
                'ccd_model',
                'ccd_process_identifier'],'desc_long': 'CCD camera parameters',
 ...
 {'children': ['elapsed_time',
                ...
                'humidity',
                'stack',
                'size'],'desc_long': 'Physical properties',
 ...
 {'children': ['type_session'],'desc_long': 'Microscopy parameters',
 ...
 {'children': ['aperture_objective',
                ...
                'vacuum_level',
                'tem_spot_size',
                'camera_position'],'desc_long': 'Microscope parameters',
 ...
 {'children': ['ref_type'],'desc_long': 'Reference',
 ...
 {'children': ['temperature_tem_stage'],'defaultunits': 'K',
 ...
 {'children': ['file_binary', 'file_volume', 'file_binary_image'],'desc_long': 'Attachments',
 ...
 {'children': ['assess_ice_comments', 'ice_type', 'assess_ice_thick'],'desc_long': 'Ice parameters',
 ...
 {'children': ['vitrification_device', 'ice'],'desc_long': 'Vitrification parameters',
 ...
 {'children': ['stack_size_nx',
                ...
                'stack_data_stamp'],'desc_long': 'Image stack and tomography Parameters',
 ...
 {'children': ['temperature_specimen',
                ...
                'vitrobot_temp',
                'ddd_temperature_detector'],'desc_long': 'Temperature',
 ...
 {'children': ['title_purification',
                ...
                'number_exposure',
                'title_grid'],'desc_long': 'Unique or restrictive identifiers',
 ...
 {'children': ['tem_dose'],'desc_long': 'Dose',
  'desc_short': 'Dose',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'dose',
 ...
 {'children': ['voltage_lens', 'tem_voltage'],'desc_long': 'Voltage',
  'desc_short': 'Voltage',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'voltage',
 ...
 {'children': ['service_type',
                'service_description',
                'service_engineer',
                'service_date'],'desc_long': 'Equipment service parameters',
 ...
 {'children': ['select_substrate_grid_prep',
                ...
                'description_grid_prefreezing',
                'grids_tem_good',
                'description_grid_postfreezing'],'desc_long': 'Grid parameters',
 ...
 {'children': ['description_buffer_dilution'],'desc_long': 'Dilution',
  'desc_short': 'Dilution',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'dilution',
 ...
 {'children': ['box'],'desc_long': 'Image processing related parameters',
 ...
 {'children': ['absorbance_at_wavelength'],'desc_long': 'Absorbance',
  'desc_short': 'Absorbance',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'absorbance',
 ...
 {'children': ['volume_aliquot',
                'grid_volume_applied',
                'vitrobot_level_liquid'],'desc_long': 'Volume',
  'desc_short': 'Volume',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'volume',
 ...
 {'children': ['file_volume_masks'],'desc_long': '3D Density map or volume',
 ...
 {'children': ['zeiss_exposure',
                ...
                'scanner_cartridge',
                'source_sample',
                'nikon_gain'],'desc_long': 'Scanned micrograph parameters',
 ...
 {'children': ['film_screen_ratio',
                'film_time_develop',
                'scanner_film',
                'film_type'],'desc_long': 'Film parameters',
 ...
 {'children': ['agenda',
                ...
                'project_type',
                'biology_of_project',
                'name_project'],'desc_long': 'Project Details',
 ...
 {'children': ['lens_voltage_projector',
                ...
                'current_lens',
                'voltage_lens'],'desc_long': 'Lens Parameters',
 ...
 {'children': ['date_end',
                ...
                'date_submit',
                'service_date',
                'date_occurred'],'desc_long': 'Date and Time',
 ...
 {'children': ['y_value',
                ...
                'shell_corr_fourier'],'desc_long': 'Reconstruction details',
 ...
 {'children': ['mass_specimen'],'desc_long': 'Mass',
  'desc_short': 'Mass',
  'indexed': True,
  'keytype': 'paramdef',
  'name': 'mass',
...
# Service performed
$#service_engineer:  $$service_engineer$#service_date:  $$service_date (if different than the date occurred above)$#service_type:  $$service_type$#service_description:  $$service_description
# Attachments
$$file_binary""",
 ...
 {'desc_long': 'A manuscript in preparation',
  ...
  'keytype': 'recorddef',
  'mainview': """
# Manuscript in preparation$#title_publication: $$title_publication
...
$#date_occurred: $$date_occurred$#performed_by: $$performed_by$#frozen_by: $$frozen_by$#vitrification_device: $$vitrification_device$#title_freezing: $$title_freezing
# Grids
...
# Plunger settings
$#vitrobot_temp: $$vitrobot_temp$#vitrobot_time_blot: $$vitrobot_time_blot 
...
$#description_storage: $$description_storage""",
 ...
 {'children': ['tem', 'purification'],'desc_long': None,
 ...
 {'children': ['vitrobot_maintenance',
                ...
                'camera_maintenance'],'desc_long': 'Maintenance record for a piece of equipment',
...
""",
 ...
 {'desc_long': 'A meeting about a project. Enter the details of the meeting, e.g. agenda, minutes, and any relevant attachments.',
  ...
  'keytype': 'recorddef',
  'mainview': """
# Project meeting$#subject_notebook: $$subject_notebook $#date_occurred: $$date_occurred Attending: $$author_list 
# Meeting notes$$description_notebook 
# Attachments$$file_binary""",
...
$#performed_by: $$performed_by$#date_occurred: $$date_occurred
...
""",
 ...
 {'desc_long': 'A laboratory group',
  ...
  'keytype': 'recorddef',
  'mainview': """
# $#name_group: $$name_group$#institution: $$institution# Contact info
$#name_contact: $$name_contact$#phone_voice: $$phone_voice$#phone_fax: $$phone_fax$#phone_voice_international: $$phone_voice_international$#phone_fax_international: $$phone_fax_international $#website: $$website$#address_email: $$address_email # Address
$#address_street: $$address_street$#address_city: $$address_city$#address_state: $$address_state$#address_zipcode: $$address_zipcode$#address_international: $$address_international""",
  'name': 'group',
  'parents': ['core', 'people'],
  'private': 0,
 ...
 {'children': ['publication_abstract', 'publication_book'],'desc_long': 'A publication that results from the project. To add references of interest that were not produced by this group, the "reference" protocol may be more appropriate.',
...
# Publication Information$#author_corresponding: $$author_corresponding$#corresponding_author_contact: $$corresponding_author_contact
$#author_list: $$author_list
$#name_journal: $$name_journal$#journal_volume: $$journal_volume$#journal_date: $$journal_date$#page_range: $$page_range$#publication_in_press: $$publication_in_press
# Abstract
$$abstract
""",
  'name': 'publication',
...
$#name_pi: $$name_pi$#project_investigators: $$project_investigators
# Project Description

$#project_type: $$project_type$#description_goals: $$description_goals$#description_background: $$description_background
""",
 ...
 {'desc_long': 'This record represents a single scan of a micrograph. There may be more than one scan record per micrograph.',
  ...
  'mainview': """
# Scanned micrograph
$#date_occurred: $$date_occurred$#performed_by: $$performed_by $#scanned_by: $$scanned_by
# Images
$$file_binary_image

# Scanner
$#scanner_film: $$scanner_film$#scanner_cartridge: $$scanner_cartridge$#scan_average: $$scan_average
# Resolution and step size
$#scan_step: $$scan_step$#angstroms_per_pixel: $$angstroms_per_pixel
# Nikon specific
$#nikon_gain: $$nikon_gain
# Zeiss specific
$#zeiss_contrast: $$zeiss_contrast $#zeiss_exposure: $$zeiss_exposure$#zeiss_brightness: $$zeiss_brightness""",
  'name': 'scan',
...
""",
 ...
 {'desc_long': 'A presentation given, e.g. at a workshop or lab meeting. For talks given at conferences, the "publication_abstract" protocol may be more appropriate.',
  ...
  'mainview': """
# Presentation
$#subject_notebook: $$subject_notebook$#date_occurred: $$date_occurredAuthors: $$author_list
# Notes
$$description_notebook
# Attachments
$$file_binary
...
Form Description: $$folder_descriptionSubmit to: $$name_contact
...
$#id_aliquot:  $$id_aliquot$#description_aliquot:  $$description_aliquot 

# Tracking and sample source
$#provided_by: $$provided_by$#name_receiver: $$name_receiver$#date_occurred: $$date_occurred$#date_received: $$date_received
# Preparation
Dilute the sample in buffer: $$description_buffer_purificationFinal sample concentration: $$concentration_solution
...
""",
 ...
 {'children': ['freezing_vitrobot',
                ...
                'freezing_gatancp3',
                'freezing_pneumatic',
                'freezing_berriman'],'desc_long': None,
 ...
 {'desc_long': """A density map. For a finished reconstruction, you may want to use 'structure' protocol.""",
  ...
  'keytype': 'recorddef',
  'mainview': """
# $#title_structure: $$title_structure The structure was completed: 
$#performed_by: $$performed_by$#date_occurred: $$date_occurred
...
""",
 ...
 {'children': ['tomography',
                'microscopy_2010',
                'virus',
                'single_particle'],'desc_long': 'A session on the microscope. The start and end times are important for usage accounting. Each grid used in this microscopy session should have a grid_imaging record. Parent record should be the current microscope configuration.\n\nNote: microscopy sessions are usually created using EMDash, which manages all the other associated records and relationships, as well as logging the start and end time of the session.',
  'desc_short': 'Microscopy session',
  'keytype': 'recorddef',
  'mainview': """
# Objective$#performed_by: $$performed_by$#date_start: $$date_start$#date_end: $$date_end
# Session purpose
$#type_session: $$type_session$#description_purpose: $$description_purpose$#film_type: $$film_type
# Initial Microscope Status Check:
1. Record the ambient humidity: $$humidity_ambient2. Ensure the column vacuum pressure is at an acceptable level (i.e., less than 2x10^-5 Pa)3. The CCD camera should be retracted and its temperature should be less than -23 C4. The input cooling water temperature should be less than (param needed) C with a differential pressure of (param needed) Pa
# Setting up the microscope:
1. Fill the anti-contamination device with liquid nitrogen.  It will take approximately 45 minutes for the device to cool.  In the meantime...2. Verify that the specimen position is (0,0,0)3. Set the microscope's target voltage: $$lens_voltage_objective4. Set the total time and the step voltage (typically the total time is set between 30 and 60 minutes with the step voltage scaled appropriately)5. Bring up the HT (high tension)
# Insert the specimen into the microscope:
1. Obtain a grid from the parent freezing session to use for imaging and load it on the specimen holder2. Load the specimen in the microscope; see the microscope manual for detailed instructions3. The specimen's temperature: $$temperature_specimen  (in Kelvin).
4. Adjust the Z-height for the microscope
# Alignment:
$#aperture_condenser: $$aperture_condenser $#aperture_objective: $$aperture_objective$#tem_spot_size: $$tem_spot_size $#length_camera: $$length_camera 
Use the alignment protocol for the particular microscope to:
1. Align the Electron Gun2. Center the Objective Aperture3. Correct the Objective Astigmatism4. Set up a Parallel Beam Condition
...
""",
 ...
 {'children': ['workshop',
                'subproject',
                'project_software'],'desc_long': 'A project. This should be used in a broad sense, such as an entire collaboration. For each specific goal, an additional child project should be created. Parent will usually be a group record.',
  'desc_short': 'Project',
  'keytype': 'recorddef',
  'mainview': """
...
# Specimen
$#name_specimen: $$name_specimen$#symmetry_particle: $$symmetry_particle$#mass_specimen: $$mass_specimen$#diameter_max: $$diameter_max $#diameter_min:    $$diameter_min$#hazard_bl_max: $$hazard_bl_max 
# Project Description
$#description_goals:  $$description_goals$#description_medical_relevance:  $$description_medical_relevance$#description_background: $$description_background
# Associated sequence data
$#description_genetic: $$description_genetic(Or, for single components):$#sequence_dna: $$sequence_dna $#sequence_rna: $$sequence_rna$#sequence_protein: $$sequence_protein""",
  'name': 'project',
  'parents': ['information'],
  'private': 0,
  'typicalchld': [ 'project',
...
$#id_grid_batch: $$id_grid_batch$#grid_tem_type: $$grid_tem_type$#grid_tem_mesh_size: $$grid_tem_mesh_size
...
$#grids_tem_used: $$grids_tem_used
# Grid Pre-Treatment
$#description_grid_prefreezing: $$description_grid_prefreezing$#time_glowdischarge: $$time_glowdischarge 
...
$#vitrobot_temp: $$vitrobot_temp $#vitrobot_time_blot: $$vitrobot_time_blot $#vitrobot_blots: $$vitrobot_blots$#vitrobot_blot_offset:  $$vitrobot_blot_offset $#vitrobot_time_wait: $$vitrobot_time_wait $#vitrobot_time_step: $$vitrobot_time_step $#vitrobot_time_drain: $$vitrobot_time_drain$#vitrobot_level_liquid: $$vitrobot_level_liquid $#direction_blotting:  $$direction_blotting$#vitrobot_humid_on: $$vitrobot_humid_onNote: If the vitrobot's humidifier is on, then also set$#vitrobot_humidity to $$vitrobot_humidity
# Post-freezing
...
$$description_storage""",
 ...
 {'desc_long': 'A microscope. Whenever a major change is made to a microscope, a new microscope record should be created. Parent should be a folder containing configurations of that microscope.',
  ...
  'keytype': 'recorddef',
  'mainview': """
# $#tem_name: $$tem_name $#microscope_serialno: $$microscope_serialno $#lens_voltage_objective: $$lens_voltage_objective
# Start and end date for this configuration$#date_start:  $$date_start$#date_end: $$date_end
$#tem_polepiece: $$tem_polepiece$#aberration_chromatic: $$aberration_chromatic $#aberration_spherical: $$aberration_spherical
# Cameras$#ccd_screen_ratio: $$ccd_screen_ratio$#dose_rate_scaling_factor: $$dose_rate_scaling_factor $#film_screen_ratio: $$film_screen_ratio
...
""",
 ...
 {'desc_long': 'Gatan CP3 session',
  ...
  'mainview': """
# Gatan CP3 Session
$#date_occurred: $$date_occurred$#performed_by: $$performed_by
$#frozen_by: $$frozen_by$#vitrification_device: $$vitrification_device$#title_freezing: $$title_freezing
# Grids
...
Check the quality of each grid with a light microscope. Discard any grids that do not meet the experiment's standards    $#grids_tem_lost: $$grids_tem_lost    $#grids_tem_used: $$grids_tem_used
...
$#vitrobot_temp: $$vitrobot_temp  $#vitrobot_time_blot: $$vitrobot_time_blot $#vitrobot_blots: $$vitrobot_blots$#direction_blotting:  $$direction_blotting 
$#vitrobot_humid_on: $$vitrobot_humid_onNote: If the humidifier is on, then also set$#vitrobot_humidity to $$vitrobot_humidity
# After Freezing
...
""",
 ...
 {'children': ['core',
                ...
                'equipment',
                'experiments',
                'information'],'desc_long': 'Root protocol. Do not use.',
...
# Publication Information$#ref_type: $$ref_type

$#author_corresponding: $$author_corresponding$#corresponding_author_contact: $$corresponding_author_contact
$#author_list: $$author_list
$#name_journal: $$name_journal$#journal_volume: $$journal_volume$#journal_date: $$journal_date$#page_range: $$page_range$#publication_in_press: $$publication_in_press
# Abstract
$$abstract
...
""",
 ...
 {'children': ['person', 'group'],'desc_long': 'People and groups',
...
# Details
$#dm3_exposure_time:  $$dm3_exposure_time $#post_blank_status:  $$post_blank_status $#defocus:  $$defocus $#pre_exposure_delay:  $$pre_exposure_delay $#delta_x:  $$delta_x $#delta_y:  $$delta_y $#delta_z:  $$delta_z $#delta_tx:  $$delta_tx $#delta_ty:  $$delta_ty $#acquire_text:  $$acquire_text $#camera_index:  $$camera_index $#post_acquisition_screen_status_lowered:  $$post_acquisition_screen_status_lowered $#objective_mini_lens:  $$objective_mini_lens $#condenser_lens_3:  $$condenser_lens_3 $#condenser_lens_2:  $$condenser_lens_2 $#condenser_lens_1:  $$condenser_lens_1 $#intermediate_lens_2:  $$intermediate_lens_2 $#intermediate_lens_3:  $$intermediate_lens_3 $#coarse_objective_lens:  $$coarse_objective_lens $#condenser_mini_lens:  $$condenser_mini_lens $#fine_objective_lens:  $$fine_objective_lens $#intermediate_lens_1:  $$intermediate_lens_1 $#projector_lens:  $$projector_lens $#projector_deflectors:  $$projector_deflectors $#gun_tilt_deflectors:  $$gun_tilt_deflectors $#condenser_stigmator_deflectors:  $$condenser_stigmator_deflectors $#spot_alignment_1_deflectors:  $$spot_alignment_1_deflectors $#condenser_tilt_deflectors:  $$condenser_tilt_deflectors $#spot_alignment_2_deflectors:  $$spot_alignment_2_deflectors $#image_shift_1_deflectors:  $$image_shift_1_deflectors $#condenser_shift_deflectors:  $$condenser_shift_deflectors $#intermediate_stigmator_deflectors:  $$intermediate_stigmator_deflectors $#gun_shift_deflectors:  $$gun_shift_deflectors $#objective_stigmator_deflectors:  $$objective_stigmator_deflectors $#image_shift_2_deflectors:  $$image_shift_2_deflectors """,
  'name': 'ccd_james',
  'parents': ['ccd'],
  'private': 0,
  'typicalchld': [],
...
# Publication Information$#author_corresponding:     $$author_corresponding$#corresponding_author_contact:     $$corresponding_author_contact
$#author_list: $$author_list $#author_editor_list: $$author_editor_list$#name_book: $$name_book$#name_chapter: $$name_chapter$#page_range: $$page_range$#year_published: $$year_published$#publisher: $$publisher
# Abstract
$$abstract
...
""",
 ...
 {'children': ['grid_cryosection'],'desc_long': 'Grid preparation.',
...
$#performed_by: $$performed_by$#date_occurred: $$date_occurred
# Grid information
$#title_grid: $$title_grid$#id_grid_batch: $$id_grid_batch $#grid_tem_type: $$grid_tem_type$#grid_tem_mesh_size: $$grid_tem_mesh_size
# Grid storage
...
# Freezing or Staining
For a frozen-hydrated grid, please make sure a freezing session is linked as a parent. This will allow you to specify the full set of Vitrobot or freezing parameters.
If this particular grid deviates from the parent freezing session, you can override some of the freezing parameters below:$#vitrobot_temp: $$vitrobot_temp $#vitrobot_time_blot: $$vitrobot_time_blot $#vitrobot_blots: $$vitrobot_blots$#vitrobot_blot_offset:  $$vitrobot_blot_offset $#vitrobot_time_wait: $$vitrobot_time_wait $#vitrobot_time_step: $$vitrobot_time_step $#vitrobot_time_drain: $$vitrobot_time_drain$#vitrobot_level_liquid: $$vitrobot_level_liquid $#direction_blotting:  $$direction_blotting$#vitrobot_humid_on: $$vitrobot_humid_on
Note: If the vitrobot's humidifier is on, then also set$#vitrobot_humidity to $$vitrobot_humidity
# Post-freezing
$#description_grid_postfreezing: $$description_grid_postfreezing
$#description_storage: $$description_storage""",
...
$#id_ccd_frame:   $$id_ccd_frame $#number_exposure:   $$number_exposure  $#tem_magnification_set:   $$tem_magnification_set$#ctf_defocus_set:   $$ctf_defocus_set 
$#tem_dose_rate:   $$tem_dose_rate$#tem_dose:   $$tem_dose$#time_exposure_tem:   $$time_exposure_tem $#angstroms_per_pixel:   $$angstroms_per_pixel$#current_screen:    $$current_screen$#beam_diameter_tem:   $$beam_diameter_tem$#status_energy_filter:   $$status_energy_filter 

# Camera

$#ccd_id: $$ccd_id$#ccd_process_identifier: $$ccd_process_identifier  $#type_frame: $$type_frame  $#binning: $$binning$#size_image_ccd_x: $$size_image_ccd_x $#size_image_ccd_y: $$size_image_ccd_y  # Stage

$#position_stage_x: $$position_stage_x $#position_stage_y: $$position_stage_y$#specimen_tilt:   $$specimen_tilt  $#ctf_astig_defocus_diff: $$ctf_astig_defocus_diff$#ctf_drift_bfactor:   $$ctf_drift_bfactor$#ctf_astig_angle:   $$ctf_astig_angle$#ctf_drift_angle:   $$ctf_drift_angle 
# Assessment

$#ice_type: $$ice_type$#assess_ice_comments: $$assess_ice_comments$#assess_ice_thick: $$assess_ice_thick$#assess_image_quality: $$assess_image_quality

# Corrected CTF Parameters

$#ctf_defocus_measured: $$ctf_defocus_measured$#tem_magnification_measured: $$tem_magnification_measured$#ctf_bfactor: $$ctf_bfactor$#ctf_snr_max: $$ctf_snr_max$#ctf_ampcont: $$ctf_ampcont
...
$#def_beamshiftx:  $$def_beamshiftx$#def_beamshifty:  $$def_beamshifty$#def_beamtiltx:  $$def_beamtiltx$#def_beamtilty:  $$def_beamtilty$#def_clstigx:  $$def_clstigx$#def_clstigy:  $$def_clstigy$#def_gunshiftx:  $$def_gunshiftx$#def_gunshifty:  $$def_gunshifty$#def_guntiltx:  $$def_guntiltx$#def_guntilty:  $$def_guntilty$#def_ilstigx:  $$def_ilstigx$#def_ilstigy:  $$def_ilstigy$#def_imageshiftx:  $$def_imageshiftx$#def_imageshifty:  $$def_imageshifty$#def_olstigx:  $$def_olstigx$#def_olstigy:  $$def_olstigy$#def_plax:  $$def_plax$#def_play:  $$def_play
$#defocus_absdac:  $$defocus_absdac$#defocus_realphysval:  $$defocus_realphysval
$#digicamcond_blankbeam:  $$digicamcond_blankbeam$#digicamcond_blankingtime:  $$digicamcond_blankingtime$#digicamcond_closescreen:  $$digicamcond_closescreen$#digicamcond_dataformat:  $$digicamcond_dataformat$#digicamcond_preirradiation:  $$digicamcond_preirradiation
$#digicamprm_areabottom:  $$digicamprm_areabottom$#digicamprm_arealeft:  $$digicamprm_arealeft$#digicamprm_arearight:  $$digicamprm_arearight $#digicamprm_areatop:  $$digicamprm_areatop$#digicamprm_binning:  $$digicamprm_binning$#digicamprm_cameraname:  $$digicamprm_cameraname$#digicamprm_exposure:  $$digicamprm_exposure
$#eos_alpha:  $$eos_alpha$#eos_brightdarkmode:  $$eos_brightdarkmode$#eos_darklevel:  $$eos_darklevel$#eos_htlevel:  $$eos_htlevel$#eos_illuminationmode:  $$eos_illuminationmode
$#eos_imagingmode:  $$eos_imagingmode$#eos_magcamindex:  $$eos_magcamindex$#eos_spectrummode:  $$eos_spectrummode$#eos_spot:  $$eos_spot$#eos_stiglevel:  $$eos_stiglevel$#eos_temasidmode:  $$eos_temasidmode
$#goniopos_rotortilty:  $$goniopos_rotortilty $#goniopos_tiltx:  $$goniopos_tiltx$#goniopos_x:  $$goniopos_x $#goniopos_y:  $$goniopos_y$#goniopos_z:  $$goniopos_z
$#ht_energyshift:  $$ht_energyshift$#ht_ht:  $$ht_ht
$#intendeddefocus_valinnm:  $$intendeddefocus_valinnm 
$#lens_cl1dac:  $$lens_cl1dac$#lens_cl2dac:  $$lens_cl2dac$#lens_cl3dac:  $$lens_cl3dac$#lens_cmdac:  $$lens_cmdac$#lens_il1dac:  $$lens_il1dac$#lens_il2dac:  $$lens_il2dac$#lens_il3dac:  $$lens_il3dac$#lens_il4dac:  $$lens_il4dac$#lens_pl1dac:  $$lens_pl1dac$#lens_pl2dac:  $$lens_pl2dac$#lens_pl3dac:  $$lens_pl3dac
$#mds_blankingdef:  $$mds_blankingdef$#mds_blankingtime:  $$mds_blankingtime$#mds_blankingtype:  $$mds_blankingtype$#mds_defx:  $$mds_defx$#mds_defy:  $$mds_defy$#mds_mdsmode:  $$mds_mdsmode$#mds_shutterdelay:  $$mds_shutterdelay
$#photo_exposuremode:  $$photo_exposuremode$#photo_filmnumber:  $$photo_filmnumber$#photo_filmtext:  $$photo_filmtext$#photo_manualexptime:  $$photo_manualexptime""",
  'name': 'ccd_jadas',
  'parents': ['ccd'],
  'private': 0,
  'typicalchld': [],
...
""",
 ...
 {'children': ['presentation'],'desc_long': 'General purpose lab notebook entry; stores general notes, observations, results, etc. Attach any relevant files.',
...
# Vitrobot Session
$#performed_by: $$performed_by$#date_occurred: $$date_occurred
$#title_freezing: $$title_freezing$#vitrification_device: $$vitrification_device(Which Vitrobot is being used)
...
$#vitrobot_temp: $$vitrobot_temp $#vitrobot_time_blot: $$vitrobot_time_blot $#vitrobot_blots: $$vitrobot_blots$#vitrobot_blot_offset:  $$vitrobot_blot_offset $#vitrobot_time_wait: $$vitrobot_time_wait $#vitrobot_time_step: $$vitrobot_time_step $#vitrobot_time_drain: $$vitrobot_time_drain$#vitrobot_level_liquid: $$vitrobot_level_liquid $#direction_blotting:  $$direction_blotting 
...
$#name_conference:    $$name_conference$#city_conference:    $$city_conference$#year_published:  $$year_published
...
# After Freezing: 
$#description_grid_postfreezing: $$description_grid_postfreezing $#select_technique_freezing: $$select_technique_freezing$#description_storage: $$description_storage""",
...
""",
 ...
 {'children': [ 'scanner',
                ...
                'vitrification_device'],'desc_long': 'Generic equipment',
...
Description: $$folder_description""",
 ...
 {'children': ['subproject_software'],'desc_long': 'This is a project specifically targeted at software development rather than a biological target.',
  'desc_short': 'Software project',
  'keytype': 'recorddef',
  'mainview': """
# Software project: $$name_project
...
$#mapname:  $$mapname $#date_occurred:  $$date_occurred     $#angstroms_per_pixel:  $$angstroms_per_pixel
$#resolution_cutoff:  $$resolution_cutoff   $#shell_corr_fourier:  $$shell_corr_fourier
$#description_reconstruction:  $$description_reconstruction      $#parameters_reconstruction:  $$parameters_reconstruction    $#z_value:  $$z_value   $#y_value:  $$y_value   $#x_value:  $$x_value # Comments
...
$#name_pi: $$name_pi$#project_investigators: $$project_investigators$#project_type: $$project_type
# Specimen
$#name_specimen: $$name_specimen$#symmetry_particle: $$symmetry_particle$#mass_specimen: $$mass_specimen$#diameter_max: $$diameter_max $#diameter_min:    $$diameter_min$#hazard_bl_max: $$hazard_bl_max 
# Project Description
$#description_goals:  $$description_goals$#description_medical_relevance:  $$description_medical_relevance$#description_background: $$description_background
...
$#specimen_tilt: $$specimen_tilt$#stack_data_montage: $$stack_data_montage$#stack_stagepos: $$stack_stagepos$#tem_magnification_set: $$tem_magnification_set$#stack_intensity: $$stack_intensity
""",
  'name': 'stackimage',
  'parents': ['stack'],
  'private': 0,
...
$#ccd_process_identifier:   $$ccd_process_identifier $#number_exposure:  $$number_exposure  $#id_ccd_frame:   $$id_ccd_frame $#binning:   $$binning 
# Images
Summed image:$$file_binary_image

Raw data:$$file_binary

# MDS Setup:  Set up and note the following for Photo mode:     $#tem_dose_rate:   $$tem_dose_rate $#tem_dose:   $$tem_dose $#time_exposure_tem:   $$time_exposure_tem $#beam_diameter_tem: $$beam_diameter_tem $#tem_magnification_set: $$tem_magnification_set 
# Setup
...
# Grids
$$grid_tem_type grids will be used for this freezing session.The grids should have a $$select_substrate_grid that was prepared by: $$select_substrate_grid_prepObtain the $$grids_tem_good grid(s) from grid batch $$id_grid_batch.Each grid has a mesh size of $$grid_tem_mesh_size with a hole size of $$grid_tem_hole_sizeCheck the quality of each grid with a light microscope. Discard any grids that do not meet the experiment's standards.    $#grids_tem_lost: $$grids_tem_lost    $#grids_tem_used: $$grids_tem_used$#description_grid_prefreezing: $$description_grid_prefreezingFor glow discharge, the discharge time is $$time_glowdischarge
# Freezing
$#grid_volume_applied: $$grid_volume_applied
# Plunger settings
$#vitrobot_temp: $$vitrobot_temp  $#vitrobot_time_blot: $$vitrobot_time_blot $#vitrobot_blots: $$vitrobot_blots$#direction_blotting:  $$direction_blotting $#vitrobot_humid_on: $$vitrobot_humid_onNote: If the humidifier is on, then also set$#vitrobot_humidity to $$vitrobot_humidity
# After Freezing
$#description_grid_postfreezing: $$description_grid_postfreezing$#select_technique_freezing: $$select_technique_freezing$#description_storage: $$description_storage
""",
...
""",
 ...
 {'children': ['ccd', 'micrograph', 'scan', 'stack', 'ddd'],'desc_long': None,
...
""",
 ...
 {'children': ['person', 'folder', 'group'],'desc_long': 'Core Protocols',
  'desc_short': 'Core',
  'keytype': 'recorddef',
  'mainview': """This protocol is for organizational purposes, and is not intended to be used.""",
  'name': 'core',
 ...
 {'children': ['tomography', 'virus', 'single_particle'],'desc_long': 'This record represents a single grid during an imaging session. There may be several grid_imaging records per microscopy session. Children will be ccd, micrograph, or stack. Parents should be the project or subproject, the grid_preparation record (see freezing session), and the microscopy session.\n\nNote: grid imaging sessions are usually created using EMDash, which manages all the other associated records and relationships.',
  'desc_short': 'Grid imaging session',
  'keytype': 'recorddef',
  'mainview': """
# Grid Imaging Session
$#performed_by: $$performed_by$#date_occurred: $$date_occurred$#description_purpose: $$description_purpose$#cryoholder: $$cryoholder$#temperature_specimen: $$temperature_specimen$#tem_lowdose_method: $$tem_lowdose_method
# Micrograph Defaults
$#ctf_defocus_set: $$ctf_defocus_set$#tem_magnification_set: $$tem_magnification_set$#time_exposure_tem: $$time_exposure_tem$#tem_dose_rate: $$tem_dose_rate$#binning: $$binning$#status_energy_filter: $$status_energy_filter
""",
  'name': 'grid_imaging',
  'parents': ['tem'],
  'private': 0,
 ...
 {'children': ['stackimage'],'desc_long': 'A stack of images, usually a tomogram. Parent is a grid_imaging record, with stackimage records as children.',
...
# Values from header
$#stack_size_nx: $$stack_size_nx$#stack_size_ny: $$stack_size_ny$#stack_size_nz: $$stack_size_nz$#stack_maxangle: $$stack_maxangle$#stack_minangle: $$stack_minangle
$#stack_slitwidth: $$stack_slitwidth$#aperture_objective: $$aperture_objective$#stack_saxtonincrement: $$stack_saxtonincrement$#stack_fixedincrement: $$stack_fixedincrement$#ctf_defocus_set: $$ctf_defocus_set$#tem_magnification_set: $$tem_magnification_set$#binning: $$binning
$#stack_data_nlabl: $$stack_data_nlabl$#stack_data_labels: $$stack_data_labels 

# Additional Values from Header
$#stack_data_mode: $$stack_data_mode
$#stack_start_nx: $$stack_start_nx$#stack_start_ny: $$stack_start_ny$#stack_start_nz: $$stack_start_nz
$#stack_size_mx: $$stack_size_mx$#stack_size_my: $$stack_size_my$#stack_size_mz: $$stack_size_mz
$#stack_size_xlen: $$stack_size_xlen$#stack_size_ylen: $$stack_size_ylen$#stack_size_zlen: $$stack_size_zlen
$#stack_angle_alpha: $$stack_angle_alpha$#stack_angle_beta: $$stack_angle_beta$#stack_angle_gamma: $$stack_angle_gamma
$#stack_map_mapc: $$stack_map_mapc$#stack_map_mapr: $$stack_map_mapr$#stack_map_maps: $$stack_map_maps
$#stack_pixel_min: $$stack_pixel_min$#stack_pixel_max: $$stack_pixel_max$#stack_pixel_mean: $$stack_pixel_mean
$#stack_data_ispg: $$stack_data_ispg$#stack_data_nsymbt: $$stack_data_nsymbt$#stack_data_extheadersize: $$stack_data_extheadersize$#stack_data_creatid: $$stack_data_creatid$#stack_data_bytespersection: $$stack_data_bytespersection$#stack_data_extheaderflags: $$stack_data_extheaderflags$#stack_data_idtype: $$stack_data_idtype$#stack_data_lens: $$stack_data_lens$#stack_data_nd1: $$stack_data_nd1 $#stack_data_nd2: $$stack_data_nd2$#stack_data_vd1: $$stack_data_vd1$#stack_data_vd2: $$stack_data_vd2$#stack_data_montage: $$stack_data_montage$#stack_stagepos: $$stack_stagepos$#stack_intensity: $$stack_intensity$#stack_data_xorg: $$stack_data_xorg$#stack_data_yorg: $$stack_data_yorg$#stack_data_zorg: $$stack_data_zorg$#stack_data_cmap: $$stack_data_cmap$#stack_data_stamp: $$stack_data_stamp$#stack_data_rms: $$stack_data_rms
$#stack_data_tiltangles_orig: $$stack_data_tiltangles_orig $#stack_data_tiltangles_current: $$stack_data_tiltangles_current
""",
  'name': 'stack',
...
$#performed_by: $$performed_by$#date_occurred: $$date_occurred
# Details
$#title_structure:  $$title_structure $#source_sample:  $$source_sample $#provided_by:  $$provided_by $#processed_structure:  $$processed_structure 
# Attachments
...
$#description_goals: $$description_goals $#organizers: $$organizers$#instructors: $$instructors
# Address
$#address_street:    $$address_street$#address_city:  $$address_city$#address_state:  $$address_state $#address_zipcode:     $$address_zipcode   $#address_international:  $$address_international # Dates
...
# Agenda$$agenda """,
 ...
 {'children': ['aliquot'],'desc_long': 'A biochemical purification. There should be at least one aliquot child record.',
...
$#volume_aliquot: $$volume_aliquot$#concentration_solution: $$concentration_solution$#description_buffer_purification: $$description_buffer_purification$#description_buffer_dilution: $$description_buffer_dilution
$#description_specimen_stability: $$description_specimen_stability$#absorbance_at_wavelength: $$absorbance_at_wavelength$#wavelength_at_absorbance: $$wavelength_at_absorbance
...
$#visualization_name: $$visualization_name$#visualization_accession: $$visualization_accession$#visualization_synopsis: $$visualization_synopsis$#visualization_length: $$visualization_length 
# Status and Contact
$#project_status: $$project_status$#date_due: $$date_due $#date_complete: $$date_complete$#contact_technical: $$contact_technical
# Comments
$#comments_editor: $$comments_editor $#comments_creator: $$comments_creator $#talk_audience: $$talk_audience
# Attachments
$$file_binary
""",
  'name': 'movie',
 ...
 {'children': ['ccd_james', 'ccd_jadas'],'desc_long': 'A CCD frame. Please enter defocus, magnification, and dose at a minimum. The measured defocus and B-factor may be set after CTF correction by EMAN/EMAN2 scripts. Parent should be a grid_imaging session.\n\nNote: Please use EMDash to create images.',
...
# MDS Setup:  Set up and note the following for Photo mode:     $#tem_dose_rate:   $$tem_dose_rate $#tem_dose:   $$tem_dose $#time_exposure_tem:   $$time_exposure_tem $#beam_diameter_tem: $$beam_diameter_tem $#tem_magnification_set: $$tem_magnification_set # Setup
Camera $$ccd_id will be used to take images with a frame size of $$size_image_ccd_x pixels by $$size_image_ccd_y pixels
Using DigitalMicrograph or the appropriate method, insert the CCD camera (click Camera -> Insert Camera)
Move the microscope stage to a completely empty area
Click Camera -> Prepare Gain Reference to properly minimize the CCD's quadrant effect
...
$#tem_magnification_set:   $$tem_magnification_set$#ctf_defocus_set:   $$ctf_defocus_set $#angstroms_per_pixel:   $$angstroms_per_pixel
$#time_exposure_tem:   $$time_exposure_tem   $#tem_dose_rate:   $$tem_dose_rate$#tem_dose:   $$tem_dose
$#ccd_id: $$ccd_id$#id_ccd_frame: $$id_ccd_frame$#type_frame: $$type_frame  $#binning: $$binning$#size_image_ccd_x: $$size_image_ccd_x $#size_image_ccd_y: $$size_image_ccd_y  # Image file
$$file_binary_image
# Additional details
$#number_exposure:   $$number_exposure  $#status_energy_filter:   $$status_energy_filter$#beam_diameter_tem:   $$beam_diameter_tem$#current_screen:    $$current_screen
# Stage
$#position_stage_x: $$position_stage_x $#position_stage_y: $$position_stage_y$#specimen_tilt:   $$specimen_tilt  $#ctf_astig_defocus_diff: $$ctf_astig_defocus_diff$#ctf_drift_bfactor: $$ctf_drift_bfactor$#ctf_astig_angle: $$ctf_astig_angle$#ctf_drift_angle: $$ctf_drift_angle 
# Assessment
$#ice_type: $$ice_type$#assess_ice_comments: $$assess_ice_comments$#assess_ice_thick: $$assess_ice_thick$#assess_image_quality: $$assess_image_quality
